...
export async function sendContactEmail(data: ContactFormData) {
  ...
  try {
    ...
    const [adminMailResult, visitorMailResult] = await Promise.all([
      resend.emails.send({
    ...
    if (visitorMailResult.error) console.error("Visitor confirmation email sending failed:", visitorMailResult.error);
